...
const ModalOfertas = (props: Props) => {
  ...
  return (
    <div className='w-[100%] h-[100%] absolute top-0 left-0 bg-[#00000080] flex items-center justify-center z-50'>
      <div className='p-8 rounded-2xl bg-white relative'>
        ...
        >X</span>
        <h1 className='text-slate-900 mb-10 text-2xl text-center'>Añadir Oferta Laboral</h1>
       ...
       {alerta && 
            ...
            <button 
                className='w-[100%] p-3 rounded-xl bg-teal-600 text-white font-semibold cursor-pointer hover:bg-menuColor1 uppercase m-4 hover:bg-teal-400'
                >
                Aceptar
            </button>
