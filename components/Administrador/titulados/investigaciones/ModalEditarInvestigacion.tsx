...
const ModalEditarInvestigacion = (props: Props) => {
      ...
      const handleClick: React.MouseEventHandler<HTMLButtonElement> | undefined = (e) => {
        ...
        .then(result => {
            if (result.data.status) {
              ...
              toast.info('Investigación Editada Correctamente', {
                autoClose: 2000,
  ...
  return (
    <div className='w-[100%] h-[100%] fixed top-0 left-0 bg-[#00000080] flex items-center justify-center z-50'>
        <div className='p-8 rounded-2xl bg-white relative'>
            ...
            >X</span>
            <h1 className='text-slate-900 mb-10 text-2xl text-center'>Editar Investigación</h1>
            ...
            >
                ...
                <div className='grid grid-cols-3 gap-x-20 gap-y-3'>
                    <Input 
                        ...
                        type='number'
                        placeholder={props.investigacion.aInvestigacion}
                        onChange={e => setDatosEditados({...datosEditados, 'aInvestigacion': e.target.value})}     
                        name='aInvestigacion'
                    />
                    <Input 
                        crossOrigin={'anonimus'}
                        label="Tema de Investigación"
                        placeholder={props.investigacion.temaInvestigacion}
                        onChange={e => setDatosEditados({...datosEditados, 'temaInvestigacion': e.target.value})}     
                    ...
                    <Input 
                        ...
                        label="Institución"
                        placeholder={props.investigacion.temaInvestigacion}
                        onChange={e => setDatosEditados({...datosEditados, 'institucionInvestigacion': e.target.value})}     
...
export default ModalEditarInvestigacion